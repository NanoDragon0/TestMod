...
public class Main {
	...
	public static final String MODVER = "1.0.0"; //Можно было и просто вписать...
	
	public static CreativeTabs tabDraconCore = new CreativeTabs("DragonCore") { //Создание креативной вкладки
